  ...
  return (
    <section className="bg-[#f9f9f9] section relative mt-[40px] lg:mt-0">
      <div className="container mx-auto">
        <motion.h2 variants={fadeIn('up')} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.6 }} className="h2 max-w-[370px] lg:mb-20">
          {title}
        </motion.h2>
      </div>
      ...
      <motion.div variants={fadeIn('up')} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.2 }} className="mb-8 lg:mb-20">
        ...
        <Lightbox slides={slides} styles={{ container: { backgroundColor: 'rgba(0, 0, 0, 0.9)' } }} open={index >= 0} index={index} close={() => setIndex(-1)}/>
      </motion.div>
